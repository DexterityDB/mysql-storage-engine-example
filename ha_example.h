...
public:
     ...
     */
    const char *index_type(uint inx) { return "BPTREE"; }
    ...
    */
    ulong index_flags(uint inx, uint part, bool all_parts) const {
        return HA_READ_NEXT
                        ...
                        | HA_READ_ORDER //-> requires index_read_last_map
                        | HA_READ_RANGE
                        | HA_ONLY_WHOLE_INDEX;
    }
    ...
    */
    virtual double scan_time() {
        return (double) (stats.records) * 5.0 + 10;
    }
    ...
    */
    int read_current_row(uchar* buf);
